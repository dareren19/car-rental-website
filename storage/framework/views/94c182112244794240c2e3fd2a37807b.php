<div class="max-w-5xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6 mb-6 sm:mb-8">
        ...
        <div class="text-center sm:text-left">
            <h2 class="text-xl sm:text-2xl font-bold text-gray-900"><?php echo e(auth()->user()->name); ?></h2>
            <p class="text-sm sm:text-base text-gray-500">Member since <?php echo e(auth()->user()->created_at->format('F Y')); ?></p>
    ...
    <form class="space-y-4 sm:space-y-6" onsubmit="event.preventDefault(); saveProfile();">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div>
                ...
                <input type="text" id="first_name" value="<?php echo e(auth()->user()->name); ?>" class=" w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base rounded-lg sm:rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors duration-200" disabled>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div>
                ...
                <input type="email" id="email" value="<?php echo e(auth()->user()->email); ?>" class="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base rounded-lg sm:rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors duration-200" disabled>
            </div>
        </div>

    </form>
</div><?php /**PATH C:\Users\Admin\OneDrive\Desktop\Laravel12-ReactJS-car-rental\resources\views/users/profile.blade.php ENDPATH**/ ?>