        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div class="flex-1 text-center lg:text-left">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <span class="text-white/80 text-sm font-semibold uppercase tracking-wider">Starting
                                From</span>
                            <?php if($featuredCar->is_featured): ?>
                        ...
                        <div class="flex items-end justify-between">
                            <div>
                                <h2 class="text-white text-4xl font-black mb-2 uppercase">
                                    <?php echo e($featuredCar->brand); ?> <?php echo e($featuredCar->model); ?>

                                </h2>
                                <div class="flex items-baseline gap-1">
                                    <span
                                        class="text-white text-5xl font-black"><?php echo e(number_format($featuredCar->price_per_day, 0)); ?></span>
                                    <span class="text-white/70 text-lg">/day</span>
                                </div>
                                <!-- Year Display -->
                                <p class="text-white/60 text-sm mt-2"><?php echo e($featuredCar->year); ?> •
                                    <?php echo e($featuredCar->fuel_type); ?> • <?php echo e($featuredCar->transmission); ?></p>
                            </div>
                        ...
                        <button onclick="bookCar(<?php echo e($featuredCar->id); ?>)"
                            ...
                            Book <?php echo e($featuredCar->brand); ?> <?php echo e($featuredCar->model); ?> Now!
                        </button>
                    </div>
                <?php else: ?>
                ...
                <div class="flex justify-center lg:justify-start gap-8 mt-12">
                    <div>
                        <p class="text-white text-2xl font-bold"><?php echo e($cars->count()); ?>+</p>
                        <p class="text-slate-300">Available Cars</p>
                    </div>
                    <div>
                        <p class="text-white text-2xl font-bold"><?php echo e($cars->unique('brand')->count()); ?>+</p>
            ...
            <div class="flex-1 relative">
                <div class="relative animate-float">
                    <?php if($featuredCar): ?>
                        ...
                        <?php elseif($featuredCar->model == 'Innova'): ?>
                        ...
                        <?php elseif($featuredCar->model == 'Mirage'): ?>
                        ...
                        <?php elseif($featuredCar->model == 'Navarra'): ?>
...
<?php /**PATH C:\Users\Admin\OneDrive\Desktop\Laravel12-ReactJS-car-rental\resources\views/mainlayouts/hero.blade.php ENDPATH**/ ?>