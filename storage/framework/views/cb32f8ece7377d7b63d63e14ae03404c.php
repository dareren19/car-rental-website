                    ...
                    <div class="flex items-start space-x-3 sm:space-x-4 w-full sm:w-auto">
                        ...
                        <div class="flex-1">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-3">
                                <h3 class="font-semibold text-gray-900"><?php echo e($booking->car->model); ?></h3>
                                <span class="text-xs sm:text-sm text-gray-500">From <?php echo e($booking->start_date); ?> to
                                    <?php echo e($booking->end_date); ?></span>
                            </div>
                            <div class="flex flex-wrap items-center gap-2 mt-1">

                                <span
                                    class="px-2 py-1 <?php echo e($booking->status === 'approved'
                                        ? 'bg-green-100 text-green-800'
                                        : ($booking->status === 'cancelled'
                                            ? 'bg-red-100 text-red-800'
                                            : 'bg-yellow-100 text-yellow-800')); ?> text-xs font-medium rounded-full"><?php echo e($booking->status); ?></span>
                                <span class="text-xs sm:text-sm text-gray-500">Total days:
                                    <?php echo e($booking->total_days); ?></span>
                                <span class="text-xs sm:text-sm text-gray-500">• Total price:
                                    <?php echo e($booking->total_price); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-wrap items-center gap-2 w-full sm:w-auto justify-end">
                        
                        <form action="<?php echo e(route('booking.cancel', $booking->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Admin\OneDrive\Desktop\Laravel12-ReactJS-car-rental\resources\views/users/booking-request.blade.php ENDPATH**/ ?>