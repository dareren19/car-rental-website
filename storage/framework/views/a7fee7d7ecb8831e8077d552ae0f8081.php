        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="border-b border-gray-200 px-4 sm:px-6 overflow-x-auto">
                <div class="flex space-x-4 sm:space-x-8 min-w-max sm:min-w-0">
                    ...
                    >
                        ...
                        <span class="bg-yellow-100 text-yellow-800 text-xs font-medium px-1.5 sm:px-2 py-0.5 rounded-full"><?php echo e($pendingCount); ?></span>
                    </button>
            ...
            <div class="p-4 sm:p-6">
                ...
                <div id="tab-profile" class="tab-content">
                    <?php echo $__env->make('users.profile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>

                <!-- Bookings Tab -->
                <div id="tab-bookings" class="tab-content hidden">
                    <?php echo $__env->make('users.booking-request', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\OneDrive\Desktop\Laravel12-ReactJS-car-rental\resources\views/users/dashboard.blade.php ENDPATH**/ ?>