    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16 sm:h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="{{ route('car.listing') }}" class="text-gray-700 hover:text-slate-600 font-medium transition">Cars</a>
                ...
                @auth
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('dashboard') }}" class="text-gray-700 hover:text-slate-600 font-medium transition">
        ...
        <div id="mobileMenu" class="hidden md:hidden py-4 border-t border-gray-100">
            <div class="flex flex-col space-y-3">
                ...
                <a href="{{ route('car.listing') }}" class="text-gray-700 hover:text-slate-600 font-medium transition py-2 px-4 rounded-lg hover:bg-gray-50">Cars</a>
